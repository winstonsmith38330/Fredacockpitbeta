# Freda Ops Cockpit - Beta 0.2.3 Changelog

## Purpose

Beta 0.2.3 responds to Freda's first positive beta feedback and makes the app a better operating-template test. It also improves reporting.site sync diagnostics so a sync that reaches pages but does not parse KPI data is no longer treated as fully successful.
