window.FREDA_OPS_SEED = {
  "meta": {
    ...
    "mode": "Live-sales capable prototype: reporting.site POS sync + Uber/Square manual/API hooks + WhatsApp export ingestion"
  },
  "briefing": [
    "Use live POS first: refresh reporting.site before Freda reviews the morning briefing.",
    "Penrith is now connected as the priority live-sales test store; protect the 15:00-18:00 window and check cabinet before 3pm.",
    "Beverly Hills remains the volume engine; use live sales against its recent average before changing production.",
    "Taren Point needs early-trade protection and WhatsApp follow-up on stock/display signals.",
    "Frieda's Pies is Square-led; use Square/Sales export or manual monthly snapshot until a Square API token is configured.",
    "Uber must be added on top of POS because it is not included in reporting.site POS sales."
  ],
  "stores": [
    {
      "id": "bh",
  ...
  "liveSamples": {
    ...
    "source": "screenshot_sample_only_until_server_sync",
    "reportingPOS": {
      "Penrith": {
        "period": "2026-06-14",
        "totalSales": 4359.7,
    ...
    "uberEats": {
      "Beverly Hills": {
        ...
        "aov": 33.19,
        "changeSalesPct": 64,
        "sourceView": "Uber Eats screenshot sample"
      },
      "Penrith": {
        "period": "this_week",
        "sales": 2860.0,
    ...
    "square": {
      "Frieda's Pies": {
        ...
        "transactions": 1717,
        "sourceView": "Square dashboard screenshot sample"
      }
    }
  }
};
